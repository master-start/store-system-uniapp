	...
	<view class="content" :class="{'active':active}">
		...
		<view class="tabbar-box-wrap">
			<view class="tabbar-box">
				<view class="tabbar-box-item" @click="goToPage('/member/amount/amount')">
					<image class="box-image" src="../../static/img/release.png" mode="aspectFit"></image>
					<text class="explain">计额销售</text>
				</view>
				<view class="tabbar-box-item" @click="goToPage('/member/times/times')">
					<image class="box-image" src="../../static/img/video.png" mode="aspectFit"></image>
					<text class="explain">计次销售</text>
				</view>
				<view class="tabbar-box-item" @click="goToPage('/member/sell/sell')">
					<image class="box-image" src="../../static/img/qa.png" mode="aspectFit"></image>
					<text class="explain">卖场销售</text>
				</view>
			</view>
		</view>
	</view>
